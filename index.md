...
**기간** | 2021.02 - (재직중)  
**포지션** | 코어뱅킹 개발 (계정계 대외, 대행 업무 개발)    
**프로젝트** | 제휴 ATM 기기 QR 스마트출금 개발(특허 출원), 오픈뱅킹/전자망/CD망 등 공동망 개발 및 운영, 펌뱅킹/가상계좌 등 대행 업무 개발 및 운영, 계정계 개발 외 사내 시스템 개발  

### [뱅크웨어글로벌](http://bankwareglobal.com/wp/)
**기간** | 2019.01 - 2020.08 (1년 7개월)  
**포지션** | 코어뱅킹 개발 (계정계 공통 업무 개발)
**프로젝트** | CBP 5.x (코어뱅킹 솔루션)

### [맑은기술](http://www.malgn.com/)  
**기간** | 2016.03 - 2019.01 (2년 10개월)  
**포지션** | 웹 개발 (백엔드, 프론트엔드 개발)  
